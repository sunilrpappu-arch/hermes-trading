    ...
    <div class="flex flex-wrap gap-2 items-end">
      <div>
        ...
        <select id="manual-asset" class="bg-slate-800 border border-slate-700 text-slate-200 text-sm rounded px-2 py-1.5">
          ...
          <option value="KITE/USDT">KITE/USDT</option>
          ...
          <option value="NEIRO/USDT">NEIRO/USDT</option>
          ...
          <option value="SUN/USDT">SUN/USDT</option>
          <option value="TAO/USDT">TAO/USDT</option>
          <option value="TIA/USDT">TIA/USDT</option>
          <option value="TRB/USDT">TRB/USDT</option>
          ...
          <option value="ZK/USDT">ZK/USDT</option>
          <option value="ZRO/USDT">ZRO/USDT</option>
        </select>
      </div>
      <div>
